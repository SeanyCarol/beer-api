...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Seany Caroliny";
    private static final String CONTACT_GITHUB = "https://github.com/SeanyCarol";
    private static final String CONTACT_EMAIL = "seany@ice.ufjf.com";
